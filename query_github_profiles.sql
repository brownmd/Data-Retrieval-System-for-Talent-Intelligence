-- GitHub AI Talent - BigQuery Raw Events Query
-- -----------------------------------------------
-- Pulls one row per event with individual scores and timestamps.
-- Aggregation (per-user scores, tiers) is done in the local DB.
--
-- Output: username, event_type, repo_name, created_at, event_score
--
-- Run in BigQuery, save result as: ai_talent_raw_202101_202603.xlsx
